...
Current release: `v0.8.9` (April 7, 2026)
...
`nxpp` is now released as `v0.8.9`.
...
- attribute-system follow-up: `#27`
- CI / workflow follow-up: `#39`
- API clarity / docs follow-up: `#13`, `#15`, `#16`
