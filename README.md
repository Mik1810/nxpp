...
| `single_source_dijkstra()` / `bellman_ford_shortest_paths()` / `dag_shortest_paths()` | Return distances, predecessors, and full paths together instead of making users rebuild them manually. |
