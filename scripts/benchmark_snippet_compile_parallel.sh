...
usage() {
  cat <<'EOF'
Usage:
  scripts/benchmark_snippet_compile_parallel.sh [options]
  scripts/benchmark_snippet_compile_parallel.sh <snippet_folder|all> [iterations]

Examples:
  scripts/benchmark_snippet_compile_parallel.sh --snippet mcmf_cc
  scripts/benchmark_snippet_compile_parallel.sh --all --iterations 10 --jobs 8
  scripts/benchmark_snippet_compile_parallel.sh --all --iterations 10 --opt-level O3 --csv benchmark/compile_bench_all_parallel.csv
